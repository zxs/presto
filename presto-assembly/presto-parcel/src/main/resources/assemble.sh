...
jdk_download_url="http://127.0.0.1:8000/jdk-${jdk.version}-linux-x64.tar.gz"
echo $jdk_download_url
jdk_download_name="jdk-${jdk.version}-linux-x64.tar.gz"
...
cd repository
curl -s https://raw.githubusercontent.com/cloudera/cm_ext/master/make_manifest/make_manifest.py | python
